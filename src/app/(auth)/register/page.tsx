...
import { Mail, Lock, User, PiggyBank, ArrowRight, Check } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen bg-[#0B0E14] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="absolute inset-0 -z-10">
                <div className="absolute top-1/4 right-1/3 w-96 h-96 bg-emerald-500/10 rounded-full blur-[150px]" />
                <div className="absolute bottom-1/4 left-1/4 w-96 h-96 bg-amber-500/5 rounded-full blur-[150px]" />
            </div>
            ...
            <div className="hidden lg:flex lg:w-1/2 items-center justify-center p-12">
                ...
                >
                    ...
                    <h2 className="text-4xl font-bold mb-6">
                        Zacznij oszczędzać <span className="gradient-text">mądrzej</span>
                    </h2>
                    <p className="text-slate-400 text-lg mb-8">
                        Dołącz do tysięcy użytkowników, którzy osiągają swoje cele finansowe.
                    </p>
                ...
                >
                    ...
                    <Card variant="glass" className="p-8">
                        <div className="text-center mb-8">
                            ...
                            <p className="text-slate-400">Zacznij oszczędzać już dziś</p>
                        </div>
