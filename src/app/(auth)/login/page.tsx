...
export default function LoginPage() {
    ...
    const handleAppleLogin = async () => {
        toast('Logowanie Apple - wkrótce dostępne', { icon: '🍎' });
    };
    ...
    const handlePhoneLogin = async () => {
        ...
        toast('Weryfikacja SMS - wkrótce dostępna', { icon: '📱' });
    };
                ...
                <div className="relative">
                    ...
                    <Card className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-3xl p-8 shadow-2xl">
                        <div className="text-center mb-8">
                            <h1 className="text-3xl font-bold mb-2 text-white">Witaj ponownie!</h1>
